...
<body class="auth-page">
    <div class="setup-container">
        ...
        <div class="setup-content">
            ...
            <div class="info-box">
                ...
                <strong>Important:</strong> This account will be the system administrator. After creation, this setup
            ...
            <form method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="full_name" name="full_name" placeholder="e.g., System Administrator" required
                        value="<?php echo isset($_POST['full_name']) ? htmlspecialchars($_POST['full_name']) : ''; ?>">
                </div>

                <div class="form-group">
                    <label for="username">Username *</label>
                    <input type="text" id="username" name="username" placeholder="e.g., admin" required minlength="3"
                ...
                <div class="form-group">
                    ...
                    <input type="email" id="email" name="email" placeholder="admin@yourdomain.com" required
    ...
    function checkPasswordStrength(pwd) {
        ...
        document.getElementById('req-special').classList.toggle('met', /[!@#$%^&*()_+\-=\[\]{};':"\\|,.<>\/?]/.test(
            pwd));
    }
