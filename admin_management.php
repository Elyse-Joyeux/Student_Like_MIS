...
/**
 * Admin Management Page - Create and Manage Admin Accounts
 * 
 * This page is ONLY accessible to authenticated admin users.
 * Allows admins to create new admin accounts and manage existing ones.
 * 
 * Author: Elyse Joyeux
 * Version: 1.0.0
    ...
    <div class="container">
                                    ...
                                    <td>
                                        <?php if ($admin['id'] != $_SESSION['user_id']): ?>
                                            <form method="POST" action="" style="display:inline;">
                                                ...
                                                <button type="submit" class="btn btn-danger" onclick="return confirm('Are you sure you want to remove this admin account?');">
        ...
        <div class="card" style="background: #f0f4ff; border: 1px solid #bee3f8;">
            ...
            <ul style="margin-left: 20px; color: #2c5282; line-height: 1.8;">
                ...
                <li><strong>Username Restriction:</strong> Students cannot register with the username "admin" — it's reserved for admin accounts only.</li>
                <li><strong>Self-Removal:</strong> You cannot remove your own admin account from this page (for safety).</li>
                <li><strong>Audit Trail:</strong> All admin account creation and removal actions are logged for security purposes.</li>
                <li><strong>First Setup:</strong> The initial admin account is created through the dedicated setup page on first-time installation.</li>
            </ul>
        </div>
    </div>
